...
export const HeroSection = () => {
  return (
    <section className="w-full flex justify-center py-20 md:py-32 lg:py-30 overflow-hidden">
    <div className="container w-full px-4 md:px-6 relative">
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a href="#contact">
            <Button size="lg" variant="default" className="relative rounded-full h-12 px-8 text-base">

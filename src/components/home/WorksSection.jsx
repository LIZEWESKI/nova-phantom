  ...
  return (
    <section className="w-full py-12 md:py-20 bg-muted/30 relative overflow-hidden">
      ...
      <div className="container px-4 md:px-6 relative">
        ...
        >
          <Badge className="rounded-full px-4 py-1.5 text-sm font-medium" variant="secondary">{t("works.section")}</Badge>
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight">{t("works.title")}</h2>
          <p className="max-w-[800px] text-muted-foreground md:text-lg">{t("works.description")}</p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-3 gap-8 md:gap-12 relative">
          ...
          {[
            {
              step: "01",
              title: t("works.steps.0.title"),
              description: t("works.steps.0.description"),
              icon: <MessageSquare className="size-6 " />,
              color: "from-blue-500 to-indigo-600",
            },
            {
              step: "02",
              title: t("works.steps.1.title"),
              description: t("works.steps.1.description"),
              icon: <Palette className="size-6" />,
              color: "from-purple-500 to-pink-600",
            },
            {
              step: "03",
              title: t("works.steps.2.title"),
              description:t("works.steps.2.description"),
